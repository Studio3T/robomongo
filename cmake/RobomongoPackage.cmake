...
if(SYSTEM_LINUX_RHEL)
    ...
    list(APPEND CPACK_RPM_USER_FILELIST "%doc /usr/COPYRIGHT")
    list(APPEND CPACK_RPM_USER_FILELIST "%doc /usr/CHANGELOG")
    list(APPEND CPACK_RPM_USER_FILELIST "%doc /usr/DESCRIPTION")
    list(APPEND CPACK_RPM_USER_FILELIST "%doc /usr/LICENSE")
    list(APPEND CPACK_RPM_USER_FILELIST "%doc /usr/LICENSE")
    list(APPEND CPACK_PACKAGE_EXECUTABLES "/usr/bin/robomongo")
